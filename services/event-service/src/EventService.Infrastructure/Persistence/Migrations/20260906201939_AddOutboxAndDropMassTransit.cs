...
{
    /// <inheritdoc />
    public partial class AddOutboxAndDropMassTransit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    topic_arn = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    ...
                    next_try_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_outbox_messages_status_next_try_at",
                schema: "events",
                table: "outbox_messages",
